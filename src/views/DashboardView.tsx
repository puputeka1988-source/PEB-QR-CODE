        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <input
              ...
              className="block bg-slate-950 border border-slate-700 text-white font-mono font-bold text-sm px-3 py-1.5 rounded-xl focus:outline-none focus:border-emerald-500 mt-0.5"
            />
          </div>
        </div>
